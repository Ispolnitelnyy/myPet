...
branch:  
portal/modalWindow
перенс линки в сайдбар  
в навбаре кнопка с модалкой   

плагин `npm i eslint-plugin-react-hooks --save-dev` для мемоизации  
...
Пизда, починил ci сторибука 
`"overrides": {
      "@swc/core": "1.2.122",
      "swc-loader": "0.1.15"
   },`
теперь починить бы loki
---
